...
public class PropertyLoaderTests {
    private static TestScenario testScenario = TestScenario.getInstance();
    ...
    @Before
    public void prepare() {
        testScenario.setEnvironment(new TestEnvironment());
    }
    ...
    public void someValuesFromMap() {
        testScenario.setVar("first", "pervoe");
        testScenario.setVar("second", "ne_rabotaet");
    ...
    public void getValueFromPropertyFile() {
        testScenario.setVar("first", "alfalab");
        testScenario.setVar("second", "/ru/credit");
