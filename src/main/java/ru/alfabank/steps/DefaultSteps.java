...
public class DefaultSteps {
    ...
    /**
     * Устанавливается значение (в приоритете: из property, из переменной среды, значение аргумента) в заданное поле.
     ...
     * (в приоритете: из property, из переменной среды, значение аргумента)
     */
     ...
     * выражение из property, из переменной среды или значение аргумента
    ...
    /**
     * Проверка, что у элемента есть атрибут с ожидаемым значением (в приоритете: из property, из переменной среды, значение аргумента)
     */
    ...
    /**
     * Проверка, что элемент содержит указанный класс (в приоритете: из property, из переменной среды, значение аргумента)
     * Например:
    ...
    /**
     * Проверка, что значение в поле содержит значение (в приоритете: из property, из переменной среды, значение аргумента),
     * указанное в шаге
     */
    ...
    /**
     * Проверка, что значение в поле равно значению, указанному в шаге (в приоритете: из property, из переменной среды, значение аргумента)
     */
    ...
    /**
     * Добавление строки (в приоритете: из property, из переменной среды, значение аргумента) в поле к уже заполненой строке
     */
    ...
    /**
     * Нажатие на элемент по его тексту (в приоритете: из property, из переменной среды, значение аргумента)
     */
    ...
    /**
     * Ввод в поле указанного текста (в приоритете: из property, из переменной среды, значение аргумента),
    ...
    public String getPropertyOrStringVariableOrValue(String propertyNameOrVariableNameOrValue) {
        ...
        if (returnValue == null) {
            ...
            if (returnValue == null) {
                log.warn("Переменная среды " + propertyNameOrVariableNameOrValue + " не найдена");
